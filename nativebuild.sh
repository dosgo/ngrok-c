...
$CC -s build-mips/main.o build-mips/cJSON.o build-mips/sendmsg.o build-mips/nonblocking.o build-mips/global.o  build-mips/ngrok.o build-mips/sslbio.o  build-mips/openssldl.o -o build-mips/ngrokc   
